"""NRM 的 Django 配置：开发/部署模式、安全基线与第三方组件。"""
...
if MODE == "dev":
    ...
    ALLOWED_HOSTS = _env_list("NRM_ALLOWED_HOSTS")
...
LOGGING = {
    ...
    "loggers": {name: {"handlers": _LOG_HANDLERS, "level": LOG_LEVEL, "propagate": False} for name in _LOGGER_NAMES},
}
LOGGING["loggers"]["django.db.backends"]["level"] = "DEBUG" if MODE == "dev" else LOG_LEVEL
